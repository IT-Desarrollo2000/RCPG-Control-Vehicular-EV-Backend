...
namespace Application.Services
{
    public class VehicleReportServices : IVehicleReportService
    {
        ...
        public async Task<PagedList<VehicleReportDto>> GetVehicleReportAll(VehicleReportFilter filter)
        {
            ...
            string properties = "Vehicle,MobileUser,AdminUser,VehicleReportImages,Expenses,VehicleReportUses,SolvedByAdminUser,Expenses.TypesOfExpenses,Expenses.PhotosOfSpending,Maintenances,Vehicle.AssignedDepartments,Vehicle.AssignedDepartments.Company,Expenses.VehicleMaintenanceWorkshop";
        ...
        public async Task<GenericResponse<VehicleReportDto>> GetVehicleReportById(int Id)
        {
            ...
            var profile = await _unitOfWork.VehicleReportRepo.Get(filter: p => p.Id == Id, includeProperties: "Vehicle.AssignedDepartments.Company,Expenses.VehicleMaintenanceWorkshop,Vehicle,MobileUser,AdminUser,VehicleReportImages,Expenses,VehicleReportUses,SolvedByAdminUser,Expenses.TypesOfExpenses,Expenses.PhotosOfSpending,Maintenances");
